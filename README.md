> หมายเหตุ: ระบบนี้เป็น Frontend-Only (ไม่มี backend จริง) ทุกข้อมูลและผู้ใช้จะถูกเก็บใน Local Storage ของ browser เท่านั้น เหมาะสำหรับ demo หรือใช้งานส่วนตัว ไม่เหมาะกับ production จริง
